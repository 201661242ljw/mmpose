...
def parse_args():
    ...
    parser.add_argument('--config', help='train config file path', default=config_path)
    parser.add_argument('--work-dir', help='the dir to save logs and models', default=out_dir)
    parser.add_argument(
        '--resume',
        # default=r"E:\LJW\Git\mmpose\tools\LJW_Log\2023-12-15_22-35-48\best_coco_AP_epoch_30.pth",
        nargs='?',
        type=str,
        const='auto',
...
if __name__ == '__main__':
    ...
    out_dir = r"LJW_Log/{}".format(formatted_time)
    if not os.path.exists(out_dir):
        os.makedirs(out_dir)

    config_path = r"../configs/0_tower/td-hm_hrnet-w48_8xb32-210e_tower_2.py"
